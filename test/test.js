...
const { preOrderArray, inOrderArray, postOrderArray } = require('../problems/02-tree-order.js');
...
describe('bfs()', () => {
  ...
  it('should return the values of a tree in bfs order', () => {
    ...
    expect(bfs(constructBalancedTree())).to.eql(['a', 'b', 'c', 'd', 'e', 'f', 'g']);
    expect(bfs(constructUnbalancedTree())).to.eql(['h', 'i', 'k', 'j', 'l', 'm']);
  });
});
